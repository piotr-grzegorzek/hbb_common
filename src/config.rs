...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDeskPalomar".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.0.9"];
pub const RS_PUB_KEY: &str = "u6yzIZOgoNMQJOGJ72v8w7xd8Wr6pMplMXOWV9BY4H4=";
